...
### Performance
- Efficient game loop with 1-second ticks
...
### Developer Mode
A hidden developer menu exists for testing and debugging purposes. Those who know the secret may discover additional tools and capabilities...
...
- Crew types can be easily added to the `crewTypes` array
- Upgrades can be added to the `upgradeTypes` array
- Contracts can be added to the `contracts` array
...
### Epic Expansions Coming Soon! 🚀
- **Immersive Storytelling**: Dive into a rich, branching narrative that unfolds as you progress through the bounty hunting world
- **Dynamic Combat System**: Experience thrilling real-time battles with strategic depth and tactical decision-making
- **Revolutionary Game Modes**: Discover innovative ways to earn credits beyond traditional hunting, including heists, investigations, and more!

### Additional Enhancements
- More crew types with unique abilities
...
### Contact Information
- **Primary Email**: [kori@korikosmos.dev](mailto:kori@korikosmos.dev)
- **Admin Email**: [admin@korikosmos.dev](mailto:admin@korikosmos.dev)
